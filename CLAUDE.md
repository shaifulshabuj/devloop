...
# DevLoop — Project Development

This is the **source repository** for the devloop tool itself.

- Engine: `devloop.sh` (~9,700 lines of bash)
- TUI companion: `cmd/devloop-tui/` (Go + Bubble Tea)
- Event schema: `docs/events.md`
- Agent prompts: `.claude/agents/devloop-architect.md`, `devloop-reviewer.md`
- Config: `devloop.config.sh`

Do NOT invoke `devloop run` or any devloop pipeline commands to implement features here —
work directly on the source files using standard tools.
